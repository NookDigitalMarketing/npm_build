...
$('.foreground').scroll(function(event){
    didScroll = true;
...
function hasScrolled() {
    var st = $('.foreground_container').scrollTop();
    ...
    if (st > lastScrollTop && st > navbarHeight - 100){
        //if  Scroll Down 
		$('.foreground_container').addClass('low_opacity');
    } else {
        $('.foreground_container').removeClass('low_opacity');
